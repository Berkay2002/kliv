...
export const GavelIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="m15.41 10.59 2.12-2.12a1.5 1.5 0 0 1 2.12 2.122l-2.12 2.12" />
    <path d="m8 8-3 3" />
    <path d="m18 3 3 3" />
    <path d="m3 18 3-3" />
  </svg>
...
export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1 1.4 1.2 2" />
    <path d="M9 18h6" />
    <path d="M10 22h4" />
  </svg>
);
